  ...
  <body class="">
    ...
    <form>
      ...
      >
        ...
        <div>
          <a href="./addBook.html" class="text-blue-400 text-xl p-1"
            >Add Book</a
          >
        </div>
        ...
        <div class="flex justify-center items-center">
          <a href="#cards">
            <img src="./images/down.png" class="text-xs h-16" />
          </a>
        </div>
      </div>
    </form>
